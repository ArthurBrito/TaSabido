...
public class EditMonitoriaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void salvarAlteracoesMonitoria() {
        ...
        final String username = sharedPreferences.getString("username", "Usuario");
        monitoria = new Monitoria(id_monitoria, id_usuario, id_materia, id_subtopico, titulo, descricao, data, dia, horario, endereco);
        monitoria.setDia(dia);
        monitoria.setUsername(username);
    ...
    public JSONObject createJsonParam(Monitoria monitoria) {
        ...
        try {
            ...
            json.put("username", monitoria.getUsername());
            json.put("usuario", monitoria.getId_usuario());
            json.put("materia", monitoria.getId_materia());
            ...
            json.put("subtopico", subtopicosJson);
