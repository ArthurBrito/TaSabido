...
public class DuvidaListView {
    ...
    public DuvidaListView(ListView listview, Context view, ArrayList<Duvida> vector) {
    ...
    public void setListView(Context view, ArrayList<Duvida> vector){

        // Seta o layout e os valores do ListView
        final ArrayAdapter<Duvida> adapter = new ArrayAdapter<Duvida>(view,
                R.layout.duvidas_listview_rowlayout, R.id.label, vector);
    ...
    private void chamarDuvidaActivity(Context view, Duvida item){
        ...
        intent.putExtra("DUVIDA", item.getTitulo());
