...
//            monitoria.setId_subtopico(monitoriaParam.getId_subtopicos());
...
//        activateRealm(activity);
//        final RealmResults<Monitoria> results = realm.where(Monitoria.class).findAll();
//        final RealmList<Monitoria> monitoriasRealm = new RealmList<>();
//
//        Vector<Monitoria> monitorias = new Vector<>();
//
//        for (Monitoria monitoria : results) {
//
//            RealmList<IdSubtopico> list_id_subtopico = new RealmList<>();
//            list_id_subtopico = monitoria.getId_subtopicos();
//
//            for (IdSubtopico sub: list_id_subtopico) {
//                if (sub.id_subtopico == id_subtopico){
...
//        }
//
////        RealmResults<Monitoria> resultsMonitoria = monitorias.where().equalTo("id_subtopico", id_subtopico).findAll();
////        return castRealmQuery(results);
//        return monitorias;
//    }
//
